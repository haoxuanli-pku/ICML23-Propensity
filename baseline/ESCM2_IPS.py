...
def para(args): 
    if args.dataset == 'product': 
        ...
        args.base_model_args = {'emb_dim': 256, 'learning_rate': 0.001, 'weight_decay': 1e-3}
        args.propensity_model_args = {'emb_dim': 256, 'learning_rate': 0.001, 'weight_decay': 1e-3}
        args.loss_args = {"alpha": 1, "beta": 1}   
    elif args.dataset == 'yahooR3': 
        args.training_args = {'batch_size': 4096, 'epochs': 500, 'patience': 10, 'block_batch': [2000, 200]}
        args.base_model_args = {'emb_dim': 256, 'learning_rate': 0.005, 'weight_decay': 1e-3}
        ...
        args.base_model_args = {'emb_dim': 64, 'learning_rate': 0.001, 'weight_decay': 1e-5}
        args.propensity_model_args = {'emb_dim': 64, 'learning_rate': 0.001, 'weight_decay': 1}
        args.loss_args = {"alpha": 1, "beta": 1}
    else: 
    ...
    for epo in range(early_stopping.max_epochs):
        for u_batch_idx, users in enumerate(train_loader.User_loader): 
            for i_batch_idx, items in enumerate(train_loader.Item_loader): 
                ...
                loss = ctr_loss + loss_args["alpha"] * ctcvr_loss + loss_args["beta"] * cvr_loss_mnar               
