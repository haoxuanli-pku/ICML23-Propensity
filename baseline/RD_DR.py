...
def para(args): 
    if args.dataset == 'product':
        ...
        args.base_model_args = {'emb_dim': 256, 'learning_rate': 5e-7, 'weight_decay': 1}
        args.imputation_model_args = {'emb_dim': 256, 'learning_rate': 5e-7, 'weight_decay': 1}
        ...
        args.training_args = {'batch_size': 1024, 'epochs': 1000, 'patience': 20, 'block_batch': [2000, 200]}
        args.base_model_args = {'emb_dim': 256, 'learning_rate': 1e-6, 'weight_decay': 10}
        args.imputation_model_args = {'emb_dim': 256, 'learning_rate': 1e-6, 'weight_decay': 10}
        args.base_dr_lr = 5e-5
        args.imp_dr_lr = 5e-5
        args.base_dr_freq = 3
        args.imp_dr_freq = 3
        ...
        args.base_model_args = {'emb_dim': 128, 'learning_rate': 1e-4, 'weight_decay': 1}
        args.imputation_model_args = {'emb_dim': 128, 'learning_rate': 1e-4, 'weight_decay': 1}
