...
def para(args): 
    if args.dataset == 'product': 
        ...
        args.base_model_args = {'emb_dim': 64, 'learning_rate': 0.1, 'weight_decay': 1}
    elif args.dataset == 'yahooR3': 
        args.training_args = {'batch_size': 4096, 'epochs': 500, 'patience': 10, 'block_batch': [2000, 200]}
        args.base_model_args = {'emb_dim': 64, 'learning_rate': 0.0001, 'weight_decay': 1}
    elif args.dataset == 'coat':
        args.training_args = {'batch_size': 128, 'epochs': 500, 'patience': 20, 'block_batch': [64, 64]}
        args.base_model_args = {'emb_dim': 16, 'learning_rate': 0.001, 'weight_decay': 0.01}
    else: 
...
def train_and_eval(train_data, val_data, test_data, device = 'cuda', 
    ...
    optimizer = torch.optim.Adam(model.parameters(), lr=model_args['learning_rate'], weight_decay=0)
